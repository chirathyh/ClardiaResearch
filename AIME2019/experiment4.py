...
# Experiment 4: Healthy vs (Diabetes Only + Diabetes with Prehypertension & Hypertension).
# Only using the PPG related features. Age is dropped, and Subjects Age is matched.
...
def Experiment4(df2, df3, df4, df5):
    ...
    #select which features should be passed.
...
x,y = Experiment4(df2,df3,df4,df5)
